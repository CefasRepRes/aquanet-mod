...
knitr::kable(imports_new)

exports_new <- imports.exports(new_network, "exports")
knitr::kable(exports_new)

between_new <- vertex.betweenness(new_network)
knitr::kable(between_new)

close_new <- vertex.closeness(new_network)
knitr::kable(close_new)

between_edge_new <- edge.betweenness.summary(new_network)
knitr::kable(between_edge_new)
```
